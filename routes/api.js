...
router.get('/infocuaca', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/infocuaca?provinsi=${kota}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data.data;
             res.json({
...
router.get('/photooxy/cup', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/senja?text=${text}&theme=coffee-cup&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/cup2', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/senja?text=${text}&theme=coffee-cup2&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/glitch', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker?text=${text}&text2=${text2}&theme=glitch&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/google', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker?text=${text}&text2=${text2}&text3=${text3}&theme=google-suggestion&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/pubg', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/game?text=${text}&text2=${text2}&theme=pubg&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/battlefield', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/game?text=${text}&text2=${text2}&theme=battlefield&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/neon', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/metallic?text=${text}&theme=neon&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/glow', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/metallic?text=${text}&theme=glow&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/summer', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/alam?text=${text}&theme=summer&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/flower', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/alam?text=${text}&theme=flower&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/burn', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/random?text=${text}&theme=text-burn&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/art', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/random?text=${text}&theme=art-quote&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/wooden', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/roses?text=${text}&theme=wooden-boarch&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/golden', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/roses?text=${text}&theme=golden&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/langit', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/barus?text=${text}&theme=langit&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/pot', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/barus?text=${text}&theme=pot&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/romantic', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/apasih?text=${text}&theme=romantic&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/love', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/oaja?text=${text}&theme=love-message&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/under', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/oaja?text=${text}&theme=under-grass&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/wolf', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/ktl?text=${text}&theme=wolf-metal&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/water', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/ktl?text=${text}&theme=underwater-ocean&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/rainbow', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/dugem?text=${text}&theme=glow-rainbow&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/night', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/asw?text=${text}&theme=night-sky&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/fire', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/asw?text=${text}&theme=flaming-text&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/harry', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/ngewe?text=${text}&theme=harry-potter&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/horor', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/ngewe?text=${text}&theme=horor&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/smoke', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/tete?text=${text}&theme=smoke&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
...
router.get('/photooxy/between', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://photooxy.herokuapp.com/api/textmaker/tete?text=${text}&theme=between-royal&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
             var result = data.result;
             res.json({
